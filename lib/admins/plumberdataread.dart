...
class Plumbermainpage extends StatefulWidget {
  const Plumbermainpage({Key? key}) : super(key: key);
  @override
  State<Plumbermainpage> createState() => _Plumbermainpage();
}

class _Plumbermainpage extends State<Plumbermainpage> {
  ...
  Future getDocId() async {
    ...
    await FirebaseFirestore.instance
        ...
        .where('complaint Type', isEqualTo: 'Plumbing')
        .get()
