...
class electHome extends StatefulWidget {
  const electHome({Key? key}) : super(key: key);
  @override
  State<electHome> createState() => _adminHome();
}

class _adminHome extends State<electHome> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
          ...
          body: Column(
            children: [Expanded(child: electmainpage())],
          )),
