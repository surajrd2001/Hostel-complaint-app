...
class electmainpage extends StatefulWidget {
  const electmainpage({Key? key}) : super(key: key);
  @override
  State<electmainpage> createState() => _electmainpage();
}

class _electmainpage extends State<electmainpage> {
